INSERT INTO situation (category)
VALUES ('WEATHER');
...
VALUES ('ENGLISH', 'Thunderstorm with light rain. Take an umbrella when going out.',
        '약한 비가 동반된 천둥번개가 칩니다. 외출 시 우산을 챙기세요.', 38),
       ...
       ('ENGLISH', 'Heavy intensity drizzle. Don’t forget your umbrella when going out.',
        '강한 이슬비가 내립니다. 외출 시 우산을 잊지 마세요.', 50),
       ...
       ('ENGLISH', 'Heavy shower rain and drizzle. Be careful when going out.', '강한 소나기와 이슬비가 섞여 내립니다. 외출 시 주의하세요.',
        55),
       ...
       ('ENGLISH', 'Light rain and snow. Prepare an umbrella and warm clothes.', '약한 비와 눈이 섞여 내립니다. 우산과 따뜻한 옷을 준비하세요.',
        73),
       ...
       ('ENGLISH',
        'There are a few clouds in the sky, but it’s mostly clear. It''s a great day for a walk or outdoor activities.',
        '오늘 하늘에 약간의 구름이 있지만, 대체로 맑은 날씨입니다. 산책이나 야외 활동을 즐기기 좋은 날입니다.', 89),
       ('ENGLISH',
        'Scattered clouds are in the sky. The sunlight peeking through the clouds makes for pleasant weather.',
        '오늘 하늘에는 구름이 드문드문 떠 있습니다. 햇빛이 구름 사이로 비춰 기분 좋은 날씨입니다.', 90),
       ('ENGLISH', 'There are many clouds in the sky. It might not be the best day for a picnic or outdoor activities.',
        '구름이 많이 끼어 있습니다. 피크닉이나 소풍 활동 하기에는 살짝 부적합할 수도 있습니다.', 91),
       ('ENGLISH', 'The sky is overcast and covered with clouds. There might be a chance of rain, so take an umbrella.',
        '오늘은 하늘이 흐리고 구름으로 덮여 있습니다. 비가 올 가능성이 있으니 우산을 챙기세요.', 92);

-- Inserting Japanese sentences into situation_sentence table with Korean translations
INSERT INTO situation_sentence (language, sentence, translation, detailed_situation_id)
VALUES ('JAPANESE', '弱い雨を伴う雷雨があります。外出時には傘を持って行ってください。',
        '약한 비가 동반된 천둥번개가 칩니다. 외출 시 우산을 챙기세요.', 38),
       ...
       ('JAPANESE', '強いにわか雨と霧雨が混じっています。外出時に注意してください。', '강한 소나기와 이슬비가 섞여 내립니다. 외출 시 주의하세요.',
        55),
       ('JAPANESE', 'にわか雨と霧雨が混じっています。軽い傘を準備してください。', '소나기와 이슬비가 섞여 내립니다. 가벼운 우산을 준비하세요.',
        56),
       ...
       ('JAPANESE', '弱い雨と雪が混じって降っています。傘と暖かい服を準備してください。',
        '약한 비와 눈이 섞여 내립니다. 우산과 따뜻한 옷을 준비하세요.', 73),
       ...
       ('JAPANESE', '今日の空には少し雲がありますが、概ね晴れています。散歩や屋外活動に最適な日です。',
        '오늘 하늘에 약간의 구름이 있지만, 대체로 맑은 날씨입니다. 산책이나 야외 활동을 즐기기 좋은 날입니다.', 89),
       ('JAPANESE', '今日の空には点々と雲があります。雲の間から太陽が覗いていて気持ちの良い天気です。',
        '오늘 하늘에는 구름이 드문드문 떠 있습니다. 햇빛이 구름 사이로 비춰 기분 좋은 날씨입니다.', 90),
       ('JAPANESE', '空には多くの雲がかかっています。ピクニックや外での活動には少し不向きかもしれません。',
        '구름이 많이 끼어 있습니다. 피크닉이나 소풍 활동 하기에는 살짝 부적합할 수도 있습니다.', 91),
       ('JAPANESE', '今日は空が曇っていて雲で覆われています。雨が降る可能性があるので傘を持って行ってください。',
        '오늘은 하늘이 흐리고 구름으로 덮여 있습니다. 비가 올 가능성이 있으니 우산을 챙기세요.', 92);
